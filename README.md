...
## Structure
- `index.html` — landing page (hero, selected work by category, tools, experience & education, stack, contact). Dark/light theme toggle persisted in localStorage.
...
## Live site
GitHub Pages: Settings → Pages → Deploy from branch `main` / root. URL: `https://youssefabdelbaki.github.io/Portfolio/`
